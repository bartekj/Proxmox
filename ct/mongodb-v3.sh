...
| |\/| |/ _ \| '_ \ / _' |/ _ \| |  | |  _ <
| |  | | (_) | | | | (_| | (_) | |__| | |_) |
|_|v3|_|\___/|_| |_|\__, |\___/|_____/|____/
                     __/ |
                    |___/
${CL}"
}
...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/bartekj/Proxmox/mongodb/setup/mongodb-install.sh)" || exit
